...
MODIFIED BY james.denton@rackspace.com
...
SUPPORTED_SCHEMA_VERSIONS = [HAVANA]
...
class BaseMigrateToMl2_Icehouse(object):
    ...
    def define_ml2_tables(self, metadata):
        ...
        sa.Table(
            ...
            sa.Column('cap_port_filter', sa.Integer, default='1', nullable=False),
...
def main():
    ...
    parser.add_argument('--tunnel-type', choices=[GRE,VXLAN],
